    ...
    <>
      ...
      <main className={styles.home}>
        <section className="container" onMouseEnter={resetGreet} onMouseLeave={() => setGreet(change[1])}>
          <div className={styles.intro}>
            ...
            <div className={styles.wrapper} onMouseEnter={() => setGreet(change[0])} onMouseLeave={resetGreet}>
              <Image className={styles.image} src="/media/profile.jpg" alt="Anant Dhok" layout="fill" objectFit="cover" />
            </div>
          </div>
        </section>
        ...
        <section className="container">
          <h2>Explore</h2>
          <div className="grid">
            <a href="https://github.com/anantdhok" className="card" target="_blank" rel="noopener noreferrer" >
              <h3><FaGithub className="icon" tyle={{ color: "black" }} /> Development</h3>
              <p>Technical Projects, Assignments and much more.</p>
            </a>
            <a href="https://www.behance.net/anantdhok" className="card" target="_blank" rel="noopener noreferrer" >
              <h3><FaBehanceSquare className="icon" style={{ color: "blue" }} /> Design</h3>
              <p>Creative Projects, Brandings, Illustrations and much more.</p>
            </a>
            <a href="https://medium.com/@anantdhok/about" className="card" target="_blank" rel="noopener noreferrer" >
        ...
        <section className="container">
          ...
          <div className="grid">
            {Data.experiences.map((item) => (
              <a href={item.link} className="card" target="_blank" rel="noopener noreferrer" >
                <h3>
                  <span className="icon"><Image src={item.src} alt="Anant Dhok" width={item.size} height={item.size} layout="fixed" /></span>
          ...
          <div className="grid">
            {Data.projects.map((item) => (
              <a href={item.link} className="card" target="_blank" rel="noopener noreferrer" >
                ...
                <span>
                  {item.tags.map((item) => (
                    <li><em style={{ fontSize:"larger", color: item.color }}>&bull;</em> {item.title}</li>
                  ))}
                </span>
              </a>
            ))}
